...
export function template(){
 ...
 <header class="hero finalTopBar">
      ...
      <div class="appVersion finalVersion">v15.8 Visual Viewport Fix</div>
     </header>
 <main>
...
<div class="sectionTitle"><h2>Застосунок</h2></div>
 <div class="card profileMenuCard">
  ...
  <button class="profileMenuRow" id="aboutAppRow"><span class="profileMenuIcon">ℹ</span><span><b>Про застосунок</b><small>Моя робота · v15.8 Visual Viewport Fix</small></span><span class="profileMenuChevron">›</span></button>
 </div>
